...
This bot uses a centralized configuration approach with all settings defined in the `config.js` file. We have removed the need for environment variables (.env files) to simplify deployment and configuration.
